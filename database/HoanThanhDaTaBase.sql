...
CREATE VIEW THONGKEBANHANG AS
 ...
 go
 -- view lich su mua hang
 CREATE VIEW LICHSUMUAHANG AS
 SELECT KHACHHANG.MaKH, CHITIETHD.MaHD,NgayLapHD,MaNV, SANPHAM.TenSP, SoLuong, CHITIETHD.Gia
 FROM KHACHHANG, HOADON, CHITIETHD, SANPHAM
 where HOADON.MaKH=KHACHHANG.MaKH and HOADON.MaHD=CHITIETHD.MaHD and CHITIETHD.MaSP=SANPHAM.MaSP

 ------------------------Nhap du lieu-----------------------------------------------------------------------------------------------------------------
 -- 1 . Danh muc
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM01',N'Nước hoa');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM02',N'Kem dưỡng da');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM03',N'Mặt nạ');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM04',N'Phấn trang điểm');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM05',N'Nhuộm và tẩy tóc');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM06',N'Xà phòng tắm , xà phòng khử mùi');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM07',N'Chất khử mùi và chống mùi');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM08',N'Sản phẩm tẩy lông');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM09',N'Sản phẩm dùng cạo râu');
INSERT INTO DANHMUC (MaDM,TenDM) VALUES ('DM010',N'Các sản phẩm để chăm sóc răng và miệng');

-- 2 . Cong ty
INSERT INTO CONGTY(MaCT,TenCT,DiaChi,SDT_CT,NgayHopTac,GiayPhep) 
VALUES ('CT01',N'Công ty mỹ phẩm Việt Nam Bách Thảo Dược',N'BT 06-23, Khu Ngoại giao đoàn, Bắc Từ Liêm, Hà Nội','0888846969','2018-06-09',N'Mã số thuế: 0201880876');

INSERT INTO CONGTY(MaCT,TenCT,DiaChi,SDT_CT,NgayHopTac,GiayPhep) 
VALUES ('CT02',N'Công ty mỹ phẩm Việt Nam Vedette',N'Đường số 1, Khu dân cư Phước Kiển A, xã Phước Kiển, Huyện Nhà Bè, TP Hồ Chí Minh','1800585876','2019-05-05',N'Giấy phép ĐKKD số 0312057925 do Sở Kế Hoạch và Đầu Tư TP.HCM cấp');

INSERT INTO CONGTY(MaCT,TenCT,DiaChi,SDT_CT,NgayHopTac,GiayPhep) 
VALUES ('CT03',N'Công ty mỹ phẩm Việt Nam Naunau',N'14A1 Hội Vũ, Hàng Bông','0938427834','2020-12-01',N'GPKD số : 0311485660 cấp ngày 21/05/2016');

INSERT INTO CONGTY(MaCT,TenCT,DiaChi,SDT_CT,NgayHopTac,GiayPhep) 
VALUES ('CT04',N'Công ty mỹ phẩm Việt Nam Skina',N' 529/94 Huỳnh Văn Bánh, Phường 14, Phú Nhuận, Thành phố Hồ Chí Minh','1900 6065','2020-05-05',N'GPKD số : 0311485684 ');

-- 3. Khach hang
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH01',N'Trần Văn Tâm',N'Quận 9 , TPHCM','0356485987');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH02',N'Nguyễn Văn An',N'Quận 2 , TPHCM','0323658475');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH03',N'Nguyễn Duy Phước',N'Quận 3 , TPHCM','0365985247');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH04',N'Võ Thị Ngọc Thắm',N'Quận 5 , TPHCM','0331545648');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH05',N'Đào Thị Cẩm Tiên',N'Quận 4 , TPHCM','0314548921');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH06',N'Hoàng Minh Nhật',N'Quận 8 , TPHCM','0301231545');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH07',N'Lê Minh Hoàng',N'Quận 7 , TPHCM','0302123154');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH08',N'Trần Thị Thu Trang',N'Quận 6 , TPHCM','0302115453');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH09',N'Trần Ngọc Tâm',N'Quận 1 , TPHCM','0302132151');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH010',N'Nguyễn Thị Tú Linh',N'Quận 10 , TPHCM','0313144415');
INSERT INTO KHACHHANG(MaKH,TenKH,DiaChi,SDT_KH) VALUES (N'KH011',N'Nguyễn Thị Tuyết Nhi',N'Quận 9 , TPHCM','0356485984');
-- 4. Nhan vien
INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV01',N'Hoàng Ngọc Trâm',N'Nhân viên','0344646445','2017-05-06',9000000,'1995-05-06');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV02',N'Nguyễn Đình Tùng',N'Nhân viên','0352648569','2018-06-09',10000000,'1993-02-01');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV03',N'Võ Hoàng Tam',N'Nhân viên','0356987584','2016-02-06',15000000,'1990-03-01');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV04',N'Nguyễn Thị Kiều Linh',N'Nhân viên','0302365847','2020-02-06',9000000,'1997-06-08');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV05',N'Nguyễn Văn Đức',N'Quản Lý','0302121145','2015-02-03',9000000,'1990-06-01');

-- 5. San pham

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM) 
VALUES (N'SP01',N'Kem Dưỡng La Roche-Posay Làm Dịu',222000,'2020-03-06','2025-03-06','DM02');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM) 
VALUES (N'SP02',N'Nước Hoa Nam HUGO BOSS Just Different EDT 40ml',1520000,'2020-05-06','2025-05-06','DM01');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM) 
VALUES (N'SP03',N'Mặt Nạ Ngủ Môi Laneige Hương Táo 20g',330000,'2021-03-06','2026-03-06','DM03');
INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM) 
VALUES (N'SP04',N'Dầu Tẩy Trang Naris Cosmetic Dành Cho Da Mụn 100ml',222000,'2020-03-03','2022-03-03','DM04');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM) 
VALUES (N'SP05',N'Kem Nhuộm Tóc Beautylabo Vanity Color Màu Đen Khói',500000,'2021-03-06','2027-03-06','DM05');
...
as
	...
	print N'Đã tạo cho bạn một mã hóa đơn '
-- Kiem tra:
...
-- 6) SAN PHAM
--them
create proc addSANPHAM(@MaSP nvarchar(10), @TenSP nvarchar(50) , @Gia int , @NSX date , @HSD date , @MaDM nvarchar(10) )
as
begin
	insert into SANPHAM(MaSP, TenSP, Gia ,NSX  , HSD , MaDM) 
	values (@MaSP , @TenSP  , @Gia  , @NSX  , @HSD  , @MaDM )
end
--exec addSANPHAM 'SP06', 'Kem ngh?', 80000 ,'2021-03-06', '2027-03-06','DM02'
...
--sua
create proc updateSANPHAM(@MaSP nvarchar(10), @TenSP nvarchar(50) , @Gia int , @NSX date , @HSD date , @MaDM nvarchar(10) )
as
begin
	update SANPHAM
	set MaSP=@MaSP , TenSP=@TenSP   , Gia=@Gia  , NSX=@NSX   , HSD=@HSD  , MaDM=@MaDM    
	where MaSP=@MaSP
end
...
as
	...
	print N'Đã tạo cho bạn một mã đơn nhập hàng'
-- Ki?m tra:
...
as
	...
	print N'Đã tạo cho bạn một mã đơn nhập hàng chi tiết'
...
as
	BEGIN
		...
		print N'Đã tạo cho bạn một hóa đơn '
	END
-- Kiem tra:
...
as
	BEGIN
		...
		print N'Đã xóa cho bạn một hóa đơn '
	END
-- Kiem tra
--exec xoaHOADON 8
...
as
	BEGIN
		...
		print N'Đã sửa cho bạn một hóa đơn '
	END
-- Kiem tra:
...
-- 6. Tai khoan
INSERT INTO TAIKHOAN(useID,password,role) VALUES ('tai','111222',1);
INSERT INTO TAIKHOAN(useID,password,role) VALUES ('tu','111222',1);
INSERT INTO TAIKHOAN(useID,password,role) VALUES ('tam','111222',0);
INSERT INTO TAIKHOAN(useID,password,role)values ('trung','123456',1);
...
-- BO SUNG THEM FUNCTION
------------------------------------------------------------------------------------------
-- 14. Th?ng kê s? l??ng hóa ??n bán hàng trong m?t kho?ng th?i gian c?a c?a hàng (?ã ki?m tra)

CREATE FUNCTION TK_SoLuongDonHang (@dateBegin date, @dateEnd date)
returns int
as
	begin 
		declare @soDon int
			SET @soDon =( 
				select count(*) 
				from THONGKEBANHANG
				where NgayLapHD >= @dateBegin and NgayLapHD < dateadd(day,1,@dateEnd)
			);
			return @SoDon;
	end

--kiem tra :
-- select dbo.TK_SoLuongDonHang('2020-03-04','2021-10-03');


--15. Th?ng kê doanh thu trong m?t kho?ng th?i gian c?a c?a hàng (?ã ki?m tra)

create function TK_DoanhThuTheoThoiGian( @dateBegin date, @dateEnd date)
returns int
as
	begin 
...
--ki?m tra :
--	select dbo.TK_DoanhThuTheoThoiGian('2020-03-04','2021-10-03');

--16. Li?t kê doanh thu m?t ngày c?a c?a hàng (?ã ki?m tra)

create function TK_DoanhThuTrongMotNgay(@date date)
returns int
as
	begin 
		declare @tongTien int
...
--kiem tra:
--	select dbo.TK_DoanhThuTrongMotNgay('2021-06-24');

--17. Th?ng kê doanh thu theo nhân viên trong m?t kho?ng th?i gian (?ã ki?m tra)
create function TK_DoanhThuTheoNhanVienTheoThoiGian( @dateBegin date, @dateEnd date )
returns table
as
		 return( 
				select MaNV,sum(ThanhTien) as N'T?ng Doanh Thu Theo Nhân Viên'
				from THONGKEBANHANG
				where NgayLapHD >= @dateBegin and NgayLapHD < dateadd(day,1,@dateEnd)
				group by MaNV
		)
--kiem tra :		
--	select * from dbo.TK_DoanhThuTheoNhanVienTheoThoiGian('2020-03-04','2021-10-03');

--18. Th?ng kê s? l??ng hóa ??n theo nhân viên trong m?t kho?ng th?i gian (?ã ki?m tra)

create function TK_SoLuongDonHangTheoNhanVien( @dateBegin date, @dateEnd date)
returns table
as
		 return( 
				select MaNV, count(*) as N'S? ??n hàng bán ???c'
				from THONGKEBANHANG
				where NgayLapHD >= @dateBegin and NgayLapHD < dateadd(day,1,@dateEnd)
				group by MaNV
		)
--kiem tra :		
--	select * from dbo.TK_SoLuongDonHangTheoNhanVien('2020-03-04','2021-10-03');

--19. Th?ng kê kho?n chi nh?p hàng theo th?i gian (?ã ki?m tra)
create function TK_KhoanChiNhapHangTheoThoiGian( @dateBegin date, @dateEnd date)
returns int
as
	begin
		 declare @tongTien int
			SET @tongTien =( 
				select sum(ThanhTien) 
				from THONGKENHAPHANG
				where NgayLap >= @dateBegin and NgayLap < dateadd(day,1,@dateEnd)
		);
		return @tongTien;
	end
--kiem tra:
-- select  dbo.TK_KhoanChiNhapHangTheoThoiGian('2020-03-04','2021-09-21');